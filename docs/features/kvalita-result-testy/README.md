...
Předchůdci: [`STATUS.md`](../../STATUS.md) (co bylo hotové před touto
vlnou), [`testing-plan.md`](../../testing-plan.md) (konvence testů, nalezené chyby),
[`nasazeni.md`](../../nasazeni.md) (nasazení).
...
> Zapsáno záměrně — `STATUS.md` psal, že „compiler pak zahození výsledku
...
Dvě kola — vlastní revize a nezávislá přes `/code-review`. Nálezy, zdůvodnění
a co z nich plyne: [`review.md`](review.md).
